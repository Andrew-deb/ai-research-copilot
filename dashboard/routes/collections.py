"""dashboard/routes/collections.py — Collections and reading plans (`/collections`)."""
...
from dashboard.services import collection_service
...
@bp.post("/<collection_id>/papers/<paper_id>/remove")
